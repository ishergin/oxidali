...
target-state, чтения и записи атрибутов, discovery, commissioning, скан, коммиссионинг,
конфигурация, индикация и identify устройств ввода, программирование групп и сцен,
зонды шины и арбитража, handover, — до `DaliTransport`. Отказ доставляется так, как
отвечает маршрут:
