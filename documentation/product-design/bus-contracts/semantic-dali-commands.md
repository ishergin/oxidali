...
подтверждённые значения и ошибку исполнения и публикуется на каждую исполненную запись,
даже когда ничего не подтвердилось. Членство в группах и сцены сюда не входят — у них свои
семейства.
