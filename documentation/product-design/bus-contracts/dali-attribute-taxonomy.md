...
| `extended` | расширенное время фейда, расширенная версия каждого объявленного типа (`extended_versions` ядра; `version_number` секции — версия DT6) | 102 §11.6.2 | расширенное время фейда |
